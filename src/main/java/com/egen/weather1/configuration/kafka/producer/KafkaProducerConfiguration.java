...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, Weather> producerFactoryJson() throws UnknownHostException{
        Map<String , Object> configProps = new HashMap<>();
        ...
        DefaultKafkaProducerFactory<String, Weather> factory = new DefaultKafkaProducerFactory<>(configProps);
        if(transactionalId != null){
            factory.setTransactionIdPrefix(transactionalId+"_"+InetAddress.getLocalHost().getHostName());
            factory.setProducerPerConsumerPartition(false);
        }
    ...
    @Bean
    public KafkaTemplate<String, Weather> kafkaTemplateJson() throws UnknownHostException {
